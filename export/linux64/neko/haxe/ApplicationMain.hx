...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "ld38-haxe", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "ld38-haxe";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ld38-haxe", null, { width: 640, height: 480 });
